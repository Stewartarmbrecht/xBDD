namespace xBDD.Features.StreamliningAPITesting
{
    ...
    public class TestSetupAndBreakdown
    {
        ...
        public static void TestRunComplete()
        {
            ...
            var htmlPath = directory + $"/../../../test-results/xBDD.Features.StreamliningAPITesting.Results.html";
            ...
            var textPath = directory + $"/../../../test-results/xBDD.Features.StreamliningAPITesting.Results.txt";
            ...
            var jsonPath = directory + $"/../../../test-results/xBDD.Features.StreamliningAPITesting.Results.json";
            ...
            var opmlPath = $"{directory}/../../../test-results/xBDD.Features.StreamliningAPITesting.Results.opml";
