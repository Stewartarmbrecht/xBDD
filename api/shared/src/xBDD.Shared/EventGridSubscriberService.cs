...
using System.IO;
using System.Linq;
using xBDD.Shared.EventSchemas.Audio;
using xBDD.Shared.EventSchemas.Categories;
using xBDD.Shared.EventSchemas.Images;
    ...
    public class EventGridSubscriberService : IEventGridSubscriberService
    {
        ...
        private object CreateStronglyTypedDataObject(object data, string eventType)
        {
            switch (eventType)
            {
                ...
                case EventTypes.TestRun.TestRunCreated:
                    return ConvertDataObjectToType<TestRunCreatedEventData>(data);
                ...
                case EventTypes.TestRun.TestRunUpdated:
                    return ConvertDataObjectToType<TestRunUpdatedEventData>(data);
                ...
                case EventTypes.TestRun.TestRunDeleted:
                    return ConvertDataObjectToType<TestRunDeletedEventData>(data);
