namespace MySample.Features.TestRun2SkippedUntested
{
    ...
    public class TestSetupAndBreakdown
    {
        ...
        public static void TestRunComplete()
        {
            ...
            var htmlPath = directory + $"/../../../test-results/MySample.Features.TestRun2SkippedUntested.Results.html";
            ...
            var textPath = directory + $"/../../../test-results/MySample.Features.TestRun2SkippedUntested.Results.txt";
            ...
            var jsonPath = directory + $"/../../../test-results/MySample.Features.TestRun2SkippedUntested.Results.json";
            ...
            var opmlPath = $"{directory}/../../../test-results/MySample.Features.TestRun2SkippedUntested.Results.opml";
