namespace MySample.Features.TestRun6Failed
{
    ...
    public class TestSetupAndBreakdown
    {
        ...
        public static void TestRunComplete()
        {
            ...
            var htmlPath = directory + $"/../../../test-results/MySample.Features.TestRun6Failed.Results.html";
            ...
            var textPath = directory + $"/../../../test-results/MySample.Features.TestRun6Failed.Results.txt";
            ...
            var jsonPath = directory + $"/../../../test-results/MySample.Features.TestRun6Failed.Results.json";
            ...
            var opmlPath = $"{directory}/../../../test-results/MySample.Features.TestRun6Failed.Results.opml";
