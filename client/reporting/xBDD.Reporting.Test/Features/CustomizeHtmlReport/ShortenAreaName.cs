...
namespace xBDD.Reporting.Test.Features.CustomizeHtmlReport
{
    [TestClass]
	[AsA("Developer")]
	[IWouldLikeTo("shorten the area name by removing the beginning of the name that matches a provided string")]
	[InOrderTo("shorten the area name in the Html report.")]
	public class ShortenAreaName
	{
		...
		public async Task MatchesStartOfAreaName()
		{
            ...
            await xB.CurrentRun.AddScenario(this)
                .Given(HtmlReport.OfASinglePassingScenario(null,null,null,"My "))
