namespace MySample.Features.TestRun5SkippedDefining
{
    ...
    public class TestSetupAndBreakdown
    {
        ...
        public static void TestRunComplete()
        {
            ...
            var htmlPath = directory + $"/../../../test-results/MySample.Features.TestRun5SkippedDefining.Results.html";
            ...
            var textPath = directory + $"/../../../test-results/MySample.Features.TestRun5SkippedDefining.Results.txt";
            ...
            var jsonPath = directory + $"/../../../test-results/MySample.Features.TestRun5SkippedDefining.Results.json";
            ...
            var opmlPath = $"{directory}/../../../test-results/MySample.Features.TestRun5SkippedDefining.Results.opml";
