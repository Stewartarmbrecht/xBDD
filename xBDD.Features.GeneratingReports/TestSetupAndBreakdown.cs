namespace xBDD.Features.GeneratingReports
{
    ...
    public class TestSetupAndBreakdown
    {
        ...
        public async static Task TestRunComplete()
        {
            ...
            var htmlPath = directory + $"/../../../test-results/xBDD.Features.GeneratingReports.Results.html";
            ...
            var textPath = directory + $"/../../../test-results/xBDD.Features.GeneratingReports.Results.txt";
            ...
            var jsonPath = directory + $"/../../../test-results/xBDD.Features.GeneratingReports.Results.json";
            ...
            var opmlPath = $"{directory}/../../../test-results/xBDD.Features.GeneratingReports.Results.opml";
