namespace xBDD.Features.DefiningFeatures
{
    ...
    public class TestSetupAndBreakdown
    {
        ...
        public async static Task TestRunComplete()
        {
            ...
            var htmlPath = directory + $"/../../../test-results/xBDD.Features.DefiningFeatures.Results.html";
            ...
            var textPath = directory + $"/../../../test-results/xBDD.Features.DefiningFeatures.Results.txt";
            ...
            var jsonPath = directory + $"/../../../test-results/xBDD.Features.DefiningFeatures.Results.json";
            ...
            var opmlPath = $"{directory}/../../../test-results/xBDD.Features.DefiningFeatures.Results.opml";
