namespace MySample.Features.TestRun1Passing
{
    ...
    public class TestSetupAndBreakdown
    {
        ...
        public static void TestRunComplete()
        {
            ...
            var htmlPath = directory + $"/../../../test-results/MySample.Features.TestRun1Passing.Results.html";
            ...
            var textPath = directory + $"/../../../test-results/MySample.Features.TestRun1Passing.Results.txt";
            ...
            var jsonPath = directory + $"/../../../test-results/MySample.Features.TestRun1Passing.Results.json";
            ...
            var opmlPath = $"{directory}/../../../test-results/MySample.Features.TestRun1Passing.Results.opml";
