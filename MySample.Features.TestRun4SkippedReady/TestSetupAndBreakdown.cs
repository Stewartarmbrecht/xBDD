namespace MySample.Features.TestRun4SkippedReady
{
    ...
    public class TestSetupAndBreakdown
    {
        ...
        public static void TestRunComplete()
        {
            ...
            var htmlPath = directory + $"/../../../test-results/MySample.Features.TestRun4SkippedReady.Results.html";
            ...
            var textPath = directory + $"/../../../test-results/MySample.Features.TestRun4SkippedReady.Results.txt";
            ...
            var jsonPath = directory + $"/../../../test-results/MySample.Features.TestRun4SkippedReady.Results.json";
            ...
            var opmlPath = $"{directory}/../../../test-results/MySample.Features.TestRun4SkippedReady.Results.opml";
